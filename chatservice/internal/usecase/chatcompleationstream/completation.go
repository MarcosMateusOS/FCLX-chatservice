...
import (
	...
	"github.com/MarcosMateusOS/fclx/chatservice/internal/domain/gateway"
...
func (uc *ChatCompletionUseCase) Execute(ctx context.Context, input ChatCompletionInputDTO) (*ChatCompletionOutputDTO, error) {
	...
	chat, err := uc.ChatGateway.FindChaByID(ctx, input.ChatID)

	if err != nil {
		if err.Error() == "chat not found" {
			// create bew chat entiy
